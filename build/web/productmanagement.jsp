            ...
            for (ProductCategory c : categoryList) {
                if (c.getCategoryId() == p.getCategoryId()) {
                    switch (c.getCategoryName()) {
                        case "Bảo hiểm nhân thọ": lifeList.add(p); break;
                        case "Bảo hiểm sức khỏe": healthList.add(p); break;
                        case "Bảo hiểm ô tô": carList.add(p); break;
                    }
                }
            }
        }
...
<div class="container">
    ...
    <div style="text-align:right; margin-bottom:15px;">
        <a href="ProductServlet?action=addCategory"
           style="background:#007bff;color:white;text-decoration:none;padding:8px 16px;border-radius:6px;">
            ➕ Thêm sản phẩm
        </a>
    </div>
    ...
    <table id="lifeTable">
        <tr>
            <th>ID</th><th>Tên sản phẩm</th><th>Thời hạn</th><th>Người thụ hưởng</th>
            <th>Giá trị bảo hiểm</th><th>Số tiền đáo hạn</th><th>Lợi ích đáo hạn</th>
            <th>Giá cơ bản</th><th>Ngày tạo</th><th>Hành động</th>
        </tr>
        <% if (!lifeList.isEmpty()) {
    ...
    <table id="healthTable">
        <tr>
            <th>ID</th><th>Tên sản phẩm</th><th>Thời hạn</th>
            <th>Giới hạn nằm viện</th><th>Giới hạn phẫu thuật</th><th>Giới hạn sinh đẻ</th>
            <th>Giá trị bảo hiểm</th><th>Độ tuổi nhỏ nhất</th><th>Độ tuổi lớn nhất</th>
            <th>Thời gian chờ</th><th>Giá cơ bản</th><th>Ngày tạo</th><th>Hành động</th>
        </tr>
    ...
    <table id="carTable">
        <tr>
            <th>ID</th><th>Tên sản phẩm</th><th>Thời hạn</th><th>Loại xe</th>
            <th>Giá trị xe</th><th>Kiểu bảo hiểm</th><th>Giá trị bảo hiểm</th>
            <th>Giá cơ bản</th><th>Ngày tạo</th><th>Hành động</th>
        </tr>
        <% if (!carList.isEmpty()) {
...
<script>
    function showTable() {
        ...
        if (selected === 'life') document.getElementById('lifeTable').style.display = 'table';
        if (selected === 'health') document.getElementById('healthTable').style.display = 'table';
        if (selected === 'car') document.getElementById('carTable').style.display = 'table';
    }
    showTable(); // Mặc định hiển thị bảng đầu tiên
</script>
</body>
</html>
