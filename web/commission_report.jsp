    ...
    <aside class="sidebar bg-primary text-white">
        <div class="sidebar-top">
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    <div class="fw-bold"><%= currentUser != null ? currentUser.getFullName() : "" %></div>
                    <div style="font-size:.85rem;opacity:.9">Agent</div>
                </div>
            </div>
        </div>
        <nav class="nav flex-column px-2">
            <a class="nav-link text-white py-2" href="#"><i class="fas fa-tachometer-alt me-2"></i> Dashboard</a>
            <a class="nav-link text-white py-2" href="#"><i class="fas fa-users me-2"></i> Khách hàng</a>
            <a class="nav-link text-white py-2" href="#"><i class="fas fa-file-signature me-2"></i> Hợp đồng</a>
            <a class="nav-link text-white active py-2" href="<%= ctx %>/agent/commission-report"><i class="fas fa-dollar-sign me-2"></i> Báo cáo Hoa hồng</a>
        </nav>
    </aside>
